...
Run `git diff --stat` and `git log --oneline -3` to see what concrete changes were made. This grounds the entry in reality.
...
Also read the most recent 2-3 files for continuity context and to avoid duplicating recent entries.
